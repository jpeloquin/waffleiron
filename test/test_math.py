...
class TestLinspaced(TestCase):
    ...
    def test_inability_to_span_error(self):
        ...
        with self.assertRaisesRegex(ValueError, "Cannot span distance"):
            feb.math.linspaced(offset, span, n)
        span = 0
        feb.math.linspaced(offset, span, n)  # Should /not/ raise
    ...
    def test_negative_span(self):
        ...
        span = -17
        x = feb.math.linspaced(offset, span, n)
        x_pos = feb.math.linspaced(-offset, -span, n)
    ...
    def test_zero_pts(self):
        ...
        n = 0
        for span in (-1, 0, 1):
            assert len(feb.math.linspaced(offset, span, n)) == 0
    ...
    def test_midpoint(self):
        ...
        n = 21
        span = 1
        mid = feb.math.linspaced(offset, span, n)[10]
...
class TestLogspaced(TestCase):
    ...
    def test_inability_to_span_error(self):
        ...
        span = 0
        feb.math.logspaced(offset, span, n)  # Should /not/ raise
    ...
    def test_len(self):
        ...
        n = 11
        for offset in (0, 3):
            assert len(feb.math.logspaced(offset, span, n)) == n
    ...
    def test_zero_pts(self):
        ...
        n = 0
        for span in (0, 1):
            assert len(feb.math.logspaced(offset, span, n)) == 0
...
class TestPowerspaced(TestCase):
    ...
    def test_inability_to_span_error(self):
        ...
        span = 0
        feb.math.powerspaced(offset, span, n, power)  # Should /not/ raise
    ...
    def test_zero_pts(self):
        ...
        for span in (0, 1):
            for power in (-0.5, 0, 0.5):
                assert len(feb.math.powerspaced(offset, span, n, power)) == 0
    ...
    def test_value_sqrt(self):
        ...
        n = 21
        power = 0.5
        x = feb.math.powerspaced(offset, span, n, power)[10]
    ...
    def test_value_linear(self):
        ...
        for offset in (0, 1, 7):
            x = feb.math.powerspaced(offset, span, n, power)
            x_true = feb.math.linspaced(offset, span, n)
