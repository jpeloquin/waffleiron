...
class Xpltreader:
    ...
    def block(blockpath):
        ...
        `blockpath` should be a sequence of block tags, delimited by
        ...
        Tag names are given in the table at the end of the FEBio
    ...
    def _readblock(self):
        ...
        data = fdata[self.cursor+8:self.cursor+8+size]
